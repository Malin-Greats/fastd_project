...
type ParcelServiceClient interface {
	...
	ChangeParcelStatus(ctx context.Context, in *ChangeParcelStatusRequest, opts ...grpc.CallOption) (*ChangeParcelStatusResponse, error)
}
...
func (c *parcelServiceClient) ChangeParcelStatus(ctx context.Context, in *ChangeParcelStatusRequest, opts ...grpc.CallOption) (*ChangeParcelStatusResponse, error) {
	out := new(ChangeParcelStatusResponse)
	err := c.cc.Invoke(ctx, "/parcel.ParcelService/ChangeParcelStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ParcelServiceServer interface {
	...
	ChangeParcelStatus(context.Context, *ChangeParcelStatusRequest) (*ChangeParcelStatusResponse, error)
...
func (UnimplementedParcelServiceServer) ChangeParcelStatus(context.Context, *ChangeParcelStatusRequest) (*ChangeParcelStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeParcelStatus not implemented")
}
...
func _ParcelService_ChangeParcelStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeParcelStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParcelServiceServer).ChangeParcelStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/parcel.ParcelService/ChangeParcelStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParcelServiceServer).ChangeParcelStatus(ctx, req.(*ChangeParcelStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ParcelService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeParcelStatus",
			Handler:    _ParcelService_ChangeParcelStatus_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/parcel/pb/parcel.proto",
}
